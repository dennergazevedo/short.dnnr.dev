        ...
        <>
          ...
          >
            ...
            <div className="mb-5 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-zinc-500">
                  Entre para organizar e acompanhar todos os seus links
                  encurtados.
                </p>
              </div>
            </div>
            ...
            <button
              ...
              className="flex flex-col gap-2 cursor-pointer w-full rounded-xl py-2.5 text-sm text-zinc-600 transition-colors hover:text-zinc-600"
            >
              Continuar sem login
              <span className="ml-1 text-xs text-zinc-400">
                (link não ficará salvo)
              </span>
            </button>
          </motion.div>
        </>
